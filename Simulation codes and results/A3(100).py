# A3 appoach for UAV handovers (UAV speed 100 km/h)
import numpy as np
...
uav_speed_mps = uav_speed_kmh * 1000 / 3600  # m/s, 33.33 m/s
wavelength = 1.0  
cycles_per_pass = int(5 / wavelength)  # 5 cycles per 5 km
pass_length_km = 38.202  # Arc length of 5 cycles
total_time_s = 1376  
measurement_interval = 0.1
num_steps = int(total_time_s / measurement_interval)  # 300
x_range_km = (total_time_s * uav_speed_kms / pass_length_km) * 5  # ~0.1091 km

# Quadrant boundaries (x_min, x_max, y_min, y_max)
quadrants = [
    (0, 5, 0, 5),
    (5, 10, 0, 5),
    (0, 5, 5, 10),
...
# SINR Calculation (Enhanced for Frequency Reuse and Power Control)
...
print("Datasets for each UAV have been saved in the 'uav_data_speed_100' directory.")
